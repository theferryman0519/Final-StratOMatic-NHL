...
#region -------------------- Public Variables --------------------
	...
	public bool IsBannerFadingIn;
	public bool IsBannerFadingOut;
#endregion
...
#region -------------------- Public Methods --------------------
    ...
    public void ShowBottomPanel(BottomPanel_Data bottomPanel, string buttonSpriteA, string buttonSpriteB)
    {
        CoreController.Inst.WriteLog(this.GetType().Name, $"Showing the bottom panel.");
        
        _bottomPanel.gameObject.SetActive(true);
        _bottomPanel.InitializePanel(bottomPanel, buttonSpriteA, buttonSpriteB);
		_bottomPanel.CanvasGroup.alpha = 0f;
